...
const DESCRIPTIONS_JA = Object.freeze({
    "300075": "フランスの哲学者・数学者。機械論的自然哲学と近代哲学に大きな影響を与えた。",
    "300610": "フランスのミニム会士。書簡を通じて17世紀の数学者・自然哲学者を結んだ。",
    "11763": "オランダの数学者・自然哲学者・天文学者。",
    "11527": "オランダの外交官・詩人。国際的な学術書簡交流にも関わった。",
    "11119": "イングランドの哲学者。物体論と政治哲学で知られる。",
    "600027": "フランスの法律家・数学者。解析幾何学、数論、極値法への貢献で知られる。",
    "900042": "フランスの哲学者・天文学者。エピクロス的原子論の再評価で知られる。",
    "903462": "フランスの数学者。幾何学と力学の研究で知られる。",
    "903506": "オランダの自然哲学者。運動・音・機械論に関する観察記録を残した。",
    "300115": "ドイツのイエズス会士・博学者。自然研究、言語、古代学にわたる著作で知られる。",
    "200001": "ボヘミア出身の教育思想家・神学者。コメニウスの名で知られる。",
    "300446": "書簡網と知識流通を支援した17世紀イングランドの知識人。",
    "600482": "イタリアの天文学者・自然哲学者。天体観測と運動論で近代科学に大きな影響を与えた。",
    "901899": "イタリアの数学者・物理学者。気圧と流体に関する研究で知られる。",
    "903445": "プファルツ選帝侯家の王女。デカルトとの書簡で心身関係を批判的に論じた。",
    "903689": "フランスの数学者。射影幾何学の先駆的研究で知られる。",
    "903715": "オランダの医師・哲学者。ユトレヒトでデカルト哲学を教授した。",
    "903716": "オランダで活動した哲学者・数学者。デカルトの知人・協力者として知られる。",
    "900356": "フランスの数学者。光学と幾何学の研究で知られる。",
    "903681": "フランスの数学者。デカルトの幾何学をめぐる書簡交流で知られる。",
    "905371": "フランスの数学者。17世紀フランスの数学論争に参加した。",
    "906102": "イタリアの数学者・物理学者。ガリレオ派の運動論に関わった。",
    "905975": "イタリアの数学者。不可分量の方法を用いた研究で知られる。",
    "902763": "フランスの神学者・哲学者。デカルト『省察』への異論提出者の一人。",
    "902731": "フランスのイエズス会士・哲学者。デカルトとの論争で知られる。",
    "16232": "フランスの学者・収集家。広範な書簡網を通じて学術情報を集めた。",
    "300521": "イングランドの数学者。代数学と教育活動で知られる。",
    "600017": "オランダの数学者。デカルト『幾何学』の編集・普及に関わった。",
    "300472": "ポーランドで活動した天文学者。月面観測と精密天文観測で知られる。",
    "900019": "オランダの法学者・思想家。国際法思想と人文主義で知られる。",
    "300095": "ドイツ出身の学者・翻訳者。イングランドの知識人ネットワークに参加した。",
    "300096": "フランスの数学者。デカルトおよび同時代数学者との書簡で知られる。",
    "900096": "ブラバントの医師・自然哲学者。化学的医学と生命論に関する著作で知られる。",
    "300645": "ドイツのルター派神学者・教育者。学術書簡の発信者として記録される。",
    "14890": "イングランドの哲学者・神学者。ケンブリッジ・プラトン学派の一員。",
    "913654": "ハノーファー選帝侯妃。近世ヨーロッパの王侯・知識人書簡網に属した。",
});
const DEFAULT_DESCRIPTION_JA = "EMLO収録の17世紀書簡関係者。詳細な役割はこのスナップショットでは未確認。";
...
function descriptionJa(id) {
    return DESCRIPTIONS_JA[id] || DEFAULT_DESCRIPTION_JA;
}
